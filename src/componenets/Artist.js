        ...
        <div>
            {!button ?
                <HStack w='100%' pt='5vh' pb='5vh' alignItems='center' spacing={!button ? '7%' : '1%'} >
                    <VStack borderRadius='30' marginLeft={!button ? '15vw' : '5%'} alignItems='auto' w={!button ? '45vw' : '80%'} h='100%' pt='2%' bgImage={cerceve1} backgroundSize={'100% 100%'} backgroundPosition={'center center'} backgroundRepeat='no-repeat'>
                        ...
                        <HStack paddingLeft={!button ? '10' : '4'} paddingTop={!button ? '5' : '2'} paddingBottom={!button ? '14' : '10'} spacing='4%'>
                ...
                :
                <VStack w='100%' pb='5vh' alignItems='center' spacing={!button ? '7%' : '5%'} >
                    <VStack  borderRadius='30' alignItems='auto' w={!button ? '45vw' : '80%'} h='100%' pt='2%' bgImage={cerceve1} backgroundSize={'100% 100%'} backgroundPosition={'center center'} backgroundRepeat='no-repeat'>
                        <Text mx='auto' fontWeight="semibold" marginTop='10' fontSize={!button ? '4xl' : 'l'} color='#52392E'>
                            Artist
                        </Text>
                        <Text alignSelf={'center'} paddingLeft='10' paddingRight={!button ? '10' : '4'} fontSize={!button ? 'xl' : 'small'} color='#52392E'>
                            Hi, it's me Saliha. I'm a freelance photographer/designer who has 8+ years of experience. I'm incredibly passionate about NFT photography and want to share my first NFT photo collection after this project.
                        </Text>
                        <Text alignSelf={'center'} fontWeight="bold" paddingLeft='10' paddingRight={!button ? '10' : '4'} fontSize={!button ? 'xl' : 'small'} color='#52392E'>
                            <strong> I would like to make discounts or give free NFTs to Sophia The Cat owners who supported me early in my journey as a photographer/designer.</strong>
                        </Text>
                        <Text alignSelf={'center'} paddingLeft='10' paddingRight={!button ? '10' : '4'} fontSize={!button ? 'xl' : 'small'} color='#52392E'>
                            I also love creating films for youtube where you can see the colorful side of the daily life.
                        ...
                        <HStack paddingLeft='10' paddingTop={!button ? '5' : '2'} paddingBottom={!button ? '10' : '10'} spacing='4%'>
                            <a href='https://www.youtube.com/channel/UChOt7j8ExcuJIMWvQhtyR0g'>
                                <Icon w={!button ? '50px' : '30px'} h={!button ? '50px' : '30px'} as={FaYoutube} color='#9a6e5d' />
                            </a>
                            <a href='https://www.instagram.com/eksi.film/'>
